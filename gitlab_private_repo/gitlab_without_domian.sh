...
# start the below script is used for domain name specification
...
# end the below script is used for domain name specification
...
# echo -e "${YELLOW}... Updating GitLab configuration...${NC}"
# if ! sudo gitlab-ctl reconfigure; then 
#     echo -e "${RED}... Failed to configure GitLab ${NC}"
#     exit 1 
# else
